...
dim = 3
def compute_model_roll(state_array, trace_array, E_array, pc=0.9, pr=0.95):
...
if __name__ == "__main__":
    ...
    res = compute_model_roll(state_array, trace_array, E_array, pc = 0.8, pr=0.999)
    cc = res['coef_center']
    cr = res['coef_radius']
    with open(os.path.join(script_dir,'model_roll2.json'),'w+') as f:
